...
class CassandraQueueRepoIT {
  ...
  private static final CassandraQueueRepo repo = new CassandraQueueRepo(session, KEYSPACE, TABLE);
  private static final int COUNT = 100;
  private static final List<QueueItem> rows = List.range(0, COUNT)
                                                  .map(i -> new QueueItem(AGG_ID, i, String.valueOf(i)));
